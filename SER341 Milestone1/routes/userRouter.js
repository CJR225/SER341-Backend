...
router.route('/professor/createAccount')
.post(function(req,res){
    console.log(req.body);
...
router.route('/professor/:professorId/courses/:courseId') 
//updating a course
...
router.route('/professor/:professorId/courses/:courseId/submissions')
...
router.route('/professor/:professorId/courses/:courseId/submissions/:submissionId')
.put(function(req,res){
